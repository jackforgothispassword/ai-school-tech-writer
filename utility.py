...
from langchain_core.output_parser.string import StrOutputParser
...
def format_data_for_openai(diffs, readme_content, commit_messages):
    ...
    readme_content = base64.b64decode(readme_contents).decode('utf-8')
...
def update_readme_and_create_pr(repo, updated_readme, readme_sha):
    ...
    new_branch = repo.create_git_ref(ref=f'refs/headss/{new_branch_name}', sha=main_branch.commit.sha)
